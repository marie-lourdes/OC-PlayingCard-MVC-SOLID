...
public class Games {
	...
	public static void main(String args[]) {
		...
		/*
		 * SomeClass a = new SomeClass(); a.someField = 1202; a.someField2 = 5456;
		 * System.out.println(a.someField); SomeClass b = (SomeClass) a.clone();
		 * 
		 * // a.someField remains 1202 // since it is a different object
		 * 
		 * b.someField = 5; System.out.println(b.someField);
		 * System.out.println(a.someField); System.out.println(b.someField2);
		 */
